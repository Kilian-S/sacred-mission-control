...
STRATEGIES: dict[str, tuple[str, str]] = {
    ...
    "alns": ("ALNS",
             "the industry-standard route planner; always plays the same plan"),
    "alns_forced_stack": ("ALNS, forced to convoy together",
                          "a fairness check"),
    "forced_stack": ("ALNS, forced to convoy together",
                     "a fairness check"),
